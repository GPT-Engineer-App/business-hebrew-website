    ...
    <Container maxW="container.xl" p={4} bg="blue.50">
      <VStack spacing={8}>
        <Box w="100%" bg="blue.200" p={4} borderRadius="md" textAlign="center">
          <Image src="https://images.unsplash.com/photo-1620288627223-53302f4e8c74?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxoYW5keW1hbiUyMGxvZ298ZW58MHx8fHwxNzE4MTcyNTM5fDA&ixlib=rb-4.0.3&q=80&w=1080" alt="א.ל פרויקטים לוגו" mx="auto" />
        </Box>
